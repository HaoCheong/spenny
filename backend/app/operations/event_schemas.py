from app.operations.bucket_schemas import BucketReadNR
from app.operations.operation_schemas import Operation
from typing import List, Optional, TYPE_CHECKING, Union, Literal, Annotated
from pydantic import BaseModel, ConfigDict, Field, model_validator
from datetime import datetime
from app.operations.trigger_schema import Trigger
